...
function AppRoutes() {
  ...
  return (
    ...
    >
      <Stack.Screen name="Home" component={HomeScreen} options={{ title: 'Painel de Controle' }} />
      ...
      <Stack.Screen name="RegistrarFilial" component={RegistrarFilialScreen} options={{ title: 'Nova Filial' }} />
